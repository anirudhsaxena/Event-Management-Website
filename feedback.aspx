<%@ Page Language="VB" AutoEventWireup="false" CodeFile="feedback.aspx.vb" Inherits="feedback"  AspCompat="true" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Untitled Page</title><link rel="stylesheet" href="index.css" type="text/css"  /><style type="text/css">
input:focus
{
      ...
      <div id="seasonal">
        <div class="inner">
          ...
          <h3>
              Feedback Form</h3>
           <p>
              Please provide us with your valuable feedback:</p>
<form name="form1" action="add_to_database_2.aspx" method="post">
    &nbsp;<table width="80%" border="0" style="height: 184px">
<tr>
<td style="width: 89px">Name :</td>
<td style="width: 259px"><input type="text" name="name" id="TextBoxName" maxlength="21" style="width: 248px"></td>
</tr>
<tr>
<td style="width: 89px; height: 38px;">Email :</td>
<td style="width: 259px; height: 38px;"> <input type="text" name="email" style="width: 248px" id="TextEmail" language="javascript" onclick="return Text1_onclick()">
    &nbsp;
</td>
</tr>
<tr>
<td style="width: 89px">Comments :</td>
<td style="width: 259px"><textarea name="comments" style="width: 256px; height: 216px"></textarea></td>
</tr>
<tr>
<td style="width: 89px; height: 26px">&nbsp;</td>
<td style="width: 259px; height: 26px;"><input type="submit" value="Send Feedback" name="submit" id="Submit1" style="width: 184px"></td>
</tr>
</table>
<div align="center">
    &nbsp;</div>
