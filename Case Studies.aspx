<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Case Studies.aspx.vb" Inherits="Case_Studies" %>
    ...
    <div>
      ...
      <div id="seasonal">
        <div class="inner">
          ...
          <h3>Image Gallery</h3>
           <p> Case Study of Some of our recent Project's</p>
          <a href="eventorg/case study.pdf"><p>Wedding:-A CASE STUDY</p>
                  </div>
