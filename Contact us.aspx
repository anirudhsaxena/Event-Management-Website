...
<head runat="server">
    <title>Untitled Page</title><link rel="stylesheet" href="contact us.css" type="text/css"  />
</head>
<body>
    <div id="wrapper">
...
<p>Event Organiserzz Limited</p>
<p>
    Jss Academy of Technical Education</p>
<p>Sector-62</p>
<p>Noida</p>
<p>Uttar Pradesh</p>

<p>Tel: +91 - 0120 - 3044 8400</p>
<p>Fax: +91 - 0120 - 2491 1281</p>
            <p>
                <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/feedback.aspx">For Feedback Click Here</asp:LinkButton>&nbsp;</p>
        </div>
      </div>
      </form>
      <div id="collection">
