<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Hotels.aspx.vb" Inherits="Default5" %>
...
<h1>Event Organiserzz</h1>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
            ...
            BorderWidth="1px" CellPadding="2" DataKeyNames="ID" DataSourceID="AccessDataSource1"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="NAME OF HOTEL" HeaderText="NAME OF HOTEL" SortExpression="NAME OF HOTEL" />
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/eventorg/EMS_DATABASE.mdb"
            SelectCommand="SELECT * FROM [TABLE_H]"></asp:AccessDataSource>
