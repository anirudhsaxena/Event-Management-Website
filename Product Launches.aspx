<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Product Launches.aspx.vb" Inherits="Product_Launches" %>
    ...
    <div>
      ...
      <div id="seasonal">
        <div class="inner">
           ...
           <h3>
               &nbsp;</h3>
           <p>Event Organiserzz organizes, plans and executes seminars and offer the following services :
